...
#top right corner
plot(dataset$DateTimeProper, dataset$Voltage, type = "l", xlab = "", ylab = "Voltage")

#bottom right corner
plot(dataset$DateTimeProper, dataset$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
